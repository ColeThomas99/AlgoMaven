...
namespace AlgoMaven.Backend.Brokers.Binance.Requests
{
...
/*
 * REQUIRED PARAMS FOR EACH 'TYPE'
 * 
 * - LIMIT - timeInForce, quantity, price
 * - MARKET - quantity, quoteOrderQty
 * - STOP_LOSS - quantity, stopPrice, trailingDelta
 * - TAKE_PROFIT - timeInForce, quantity, price, stopPrice, trailingDelta
 * - LIMIT_MARKER - quantity, price
 */